...
export async function POST(req: Request) {
  ...
  try {
    ...
    const bilingualTours = [
      {
        ...
        highlights: [{ en: 'Old Town Square and Astronomical Clock', ru: 'Староместская площадь и Астрономические часы' }, { en: 'Charles Bridge with panoramic views', ru: 'Карлов мост с панорамными видами' }, { en: 'Hidden medieval courtyards', ru: 'Скрытые средневековые дворики' }, { en: 'Tyn Church and Old Town Hall', ru: 'Тынский храм и Староместская ратуша' }],
        itinerary: [{ time: '10:00', en: 'Old Town Square', ru: 'Староместская площадь', descEn: 'Meet your guide and explore the historic heart of Prague', descRu: 'Встреча с гидом и знакомство с историческим центром Праги' }, { time: '10:45', en: 'Medieval Streets', ru: 'Средневековые улицы', descEn: 'Wander through hidden courtyards and passages', descRu: 'Прогулка по скрытым дворикам и пассажам' }, { time: '11:30', en: 'Charles Bridge', ru: 'Карлов мост', descEn: 'Cross the legendary bridge with stories of its saints', descRu: 'Переход через легендарный мост с историями о его святых' }, { time: '12:30', en: 'Bridge Tower', ru: 'Мостовая башня', descEn: 'Final views and photo opportunities', descRu: 'Финальные виды и возможности для фото' }],
      ...
      },
      {
        ...
        highlights: [{ en: 'St. Vitus Cathedral', ru: 'Собор Святого Вита' }, { en: 'Golden Lane', ru: 'Злата уличка' }, { en: 'Panoramic views of Prague', ru: 'Панорамные виды на Прагу' }, { en: 'Lesser Town baroque architecture', ru: 'Барочная архитектура Малой Страны' }],
        itinerary: [{ time: '10:00', en: 'Prague Castle', ru: 'Пражский Град', descEn: 'Explore the castle grounds and courtyards', descRu: 'Исследуем территорию и дворы Града' }, { time: '10:45', en: 'St. Vitus Cathedral', ru: 'Собор Святого Вита', descEn: 'Marvel at the Gothic masterpiece', descRu: 'Восхищаемся готическим шедевром' }, { time: '11:15', en: 'Golden Lane', ru: 'Злата уличка', descEn: 'Walk through the charming medieval houses', descRu: 'Прогулка по очаровательным средневековым домикам' }, { time: '12:00', en: 'Descent to Lesser Town', ru: 'Спуск на Малую Страну', descEn: 'Scenic walk down through baroque streets', descRu: 'Живописный спуск по барочным улицам' }],
      ...
      },
      {
        ...
        highlights: [{ en: 'Private car with professional driver', ru: 'Личный автомобиль с профессиональным водителем' }, { en: 'Both banks of the Vltava', ru: 'Оба берега Влтавы' }, { en: 'Hotel pickup and drop-off', ru: 'Трансфер от отеля и обратно' }, { en: 'Areas unreachable on foot tours', ru: 'Места, недоступные пешеходным маршрутам' }],
        itinerary: [{ time: '10:00', en: 'Hotel Pickup', ru: 'Трансфер от отеля', descEn: 'Your driver picks you up at your hotel', descRu: 'Водитель забирает вас у отеля' }, { time: '10:15', en: 'Prague Castle', ru: 'Пражский Град', descEn: 'Walking tour of the castle complex', descRu: 'Пешеходная часть по территории Града' }, { time: '11:15', en: 'Driving tour', ru: 'Автомобильная часть', descEn: 'Scenic drive through Mala Strana and New Town', descRu: 'Живописная поездка через Малую Страну и Новый город' }, { time: '12:00', en: 'Old Town walk', ru: 'Пешеходная часть', descEn: 'Walking through Old Town and Charles Bridge', descRu: 'Прогулка по Старому городу и Карлову мосту' }],
    ...
    const ruOnlyTours = [
      ...
      { title: 'Чески-Крумлов', slug: 'chesky-krumlov', excerpt: 'ЮНЕСКО, замок, средневековый город, обед у реки, живописная дорога', desc: 'Чески-Крумлов — жемчужина Южной Чехии и объект ЮНЕСКО. Средневековый замок, извилистые улочки, обед на берегу реки и живописная дорога через чешскую деревню. Полный день незабываемых впечатлений.', category: 'from-prague' as const, subcategory: undefined, duration: 10, price: 299, sortOrder: 18, difficulty: 'easy' as const, tags: ['top-rated', 'transport', 'free-cancel'], rating: 5.0, reviews: 29 },
      { title: 'Кутна Гора', slug: 'kutna-gora', excerpt: 'Костница, Собор Святой Варвары, средневековый центр города', desc: 'Кутна Гора — город серебра и костей. Знаменитая Костница (Седлецкий оссуарий), величественный Собор Святой Варвары и средневековый центр города с богатой историей горнодобычи.', category: 'from-prague' as const, subcategory: undefined, duration: 7, price: 249, sortOrder: 19, difficulty: 'easy' as const, tags: ['transport', 'free-cancel'], rating: 4.8, reviews: 17 },
      { title: 'Дрезден + Саксонская Швейцария', slug: 'drezden-saksonskaya-shvejtsariya', excerpt: 'Цвингер, Фрауэнкирхе, Зелёные своды + природный парк Саксонская Швейцария', desc: 'Два путешествия за один день: Дрезден — «Флоренция на Эльбе» с Цвингером, Фрауэнкирхе и Зелёными сводами, и Саксонская Швейцария — природный парк с фантастическими скальными формациями.', category: 'from-prague' as const, subcategory: undefined, duration: 10, price: 349, sortOrder: 20, difficulty: 'moderate' as const, tags: ['transport'], rating: 4.9, reviews: 13 },
      { title: 'Вена', slug: 'vena', excerpt: 'Столица Австрии — дворцы, исторический центр, имперская архитектура', desc: 'Однодневная экскурсия в столицу Австрии. Шёнбрунн, Хофбург, Собор Святого Стефана, Рингштрассе и знаменитые венские кафе. Погружение в имперскую атмосферу одной из красивейших столиц Европы.', category: 'from-prague' as const, subcategory: undefined, duration: 12, price: 399, sortOrder: 21, difficulty: 'easy' as const, tags: ['transport'], rating: 4.8, reviews: 8 },
    ]
    ...
    for (const tour of bilingualTours) {
      ...
      const data: Record<string, unknown> = {
        ...
        highlights: tour.highlights.map(h => ({ text: h.en })),
        itinerary: tour.itinerary.map(i => ({ time: i.time, title: i.en, description: i.descEn })),
      ...
      await payload.update({
        ...
        data: {
          ...
          highlights: tour.highlights.map(h => ({ text: h.ru })),
          itinerary: tour.itinerary.map(i => ({ time: i.time, title: i.ru, description: i.descRu })),
